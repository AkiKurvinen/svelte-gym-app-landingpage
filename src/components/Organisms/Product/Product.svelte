...
<SectionWrapper id="product">
    <div
        class="flex flex-col gap-10 sm:gap-14 md:gap-24 flex-1 items-center justify-center pb-10 md:pb-14 mt-16"
    >
        <div class="flex flex-col gap-2">
            ...
            <ProductCard {index} {productFeature}>
            {#if index===0}
            Experience a beginner excercise <span class="text-indigo-400 font-medium">master</span> class
            {:else if index === 1}
